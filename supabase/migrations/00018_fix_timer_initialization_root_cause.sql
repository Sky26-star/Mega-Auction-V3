-- Migration: 00018_fix_timer_initialization_root_cause.sql
-- Description: Authoritative Root-Cause Fix for Timer Initialization, ISO Timestamp Formatting, and Fresh Start Guarantee
-- Target Engine: PostgreSQL 15+ (Supabase Cloud)

BEGIN;

-- ============================================================
-- 1. AUTHORITATIVE STATE EXPORTER WITH ISO TIMESTAMP FORMATTING
-- ============================================================
