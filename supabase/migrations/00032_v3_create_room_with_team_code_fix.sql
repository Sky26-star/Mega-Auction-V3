-- Atomic room creation and team creation for Host, updated with p_room_code and correct 'OPEN' status
...
BEGIN
  ...
  -- 1. Create Room (now includes code and correct 'OPEN' status)
